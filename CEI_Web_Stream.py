...
MAIN_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/BLACK_HEADER.png")
SUB_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/BANNER.jpg")
COL_VIS_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/SECURITY_CREW.png")
COL_SW_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/RED_WARNING_PNG.png")
COL_ND_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/SPEAK_CREW_PNG.png")
COL_GS_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/MATH_CREW_PNG.png")
