...
MAIN_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/FOR_IMAGE/BLACK_HEADER.png")
SUB_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/FOR_IMAGE/BANNER.jpg")
COL_VIS_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/FOR_IMAGE/SECURITY_CREW.png")
COL_SW_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/FOR_IMAGE/RED_WARNING_PNG.png")
COL_ND_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/FOR_IMAGE/SPEAK_CREW_PNG.png")
COL_GS_HEADER_IMAGE = Image.open("/CEI_WEB_STREAM/FOR_IMAGE/MATH_CREW_PNG.png")
